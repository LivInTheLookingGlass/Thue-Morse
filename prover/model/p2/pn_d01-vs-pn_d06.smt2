s = -1div0 = [else -> 0]mod0 = [else -> 0]gould2_13 = [else ->
 If(Var(0)%2 == 0,
 ...
 If(Var(0) < s,
    ...
    (ilog2(xorn(Var(0), Var(0) - 1, s), s) +
     Tn_07(Var(0) - 1) +
     1)%
    s)]e2_10 = [0 -> 0, else -> f2_10(e2_10(Var(0) - 1) + 1)]T2_13 = [else -> (gould2_13(Var(0)) - 1)%3]o2_09 = [0 -> 1, else -> f2_09(o2_09(Var(0) - 1) + 1)]p2_01 = [0 -> 0, else -> p2_01(Var(0)/2) + Var(0)]ilog2 = [else ->
 ...
 Concat(t2_03(Var(0) - 1), invert2_03(t2_03(Var(0) - 1)))]f2_09 = [else -> If(p2_09(Var(0))%2 == 1, Var(0), f2_09(Var(0) + 1))]ilog2_2_11 = [else -> If(Var(0) <= 1, 0, 1 + ilog2_2_11(Var(0)/2))]pn_07 = [else -> ilog2(xorn(Var(0), Var(0) - 1, s), s) + 1]xor_2_07 = [else ->
 If(Var(0) == 0,
    Var(1),
    If(Var(1) == 0,
       Var(0),
 ...
 If(Length(Var(1)) == 0,
    ...
    Concat(Var(0),
           Concat(If(str.substr(Var(1), 0, 1) == "0",
                     "01",
                     "10"),
                  str.substr(Var(1), 1, Length(Var(1)) - 1))))]T2_12 = [else -> (e2_12(Var(0)) + 1)%2]p2_11 = [else -> Var(0)/2 + (ilog2_2_11(Var(0) + 1)%2)*(Var(0)%2)]ilog2_2_04 = [else -> If(Var(0) <= 1, 0, 1 + ilog2_2_04(Var(0)/2))]