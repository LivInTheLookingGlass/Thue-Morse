...
(assert
 (forall ((n Int) )(let ((?x4366 ((_ Tn_05 0) n)))
 (let (($x2488 (= ?x4366 n)))
 (let ((?x3287 ((_ T2_01 0) n)))
 (let (($x2794 (= ?x3287 n)))
 (let (($x5370 (and $x2794 $x2488)))
 (let (($x387 (< n s)))
 (let (($x5310 (>= n 0)))
 (let (($x381 (and $x5310 $x387)))
 (=> $x381 $x5370))))))))))
 )
(assert
 (let ((?x919 ((_ T2_01 0) s)))
 (= ?x919 1)))
(assert
 (let ((?x1885 ((_ Tn_05 0) s)))
 (= ?x1885 1)))
(assert
 (forall ((n Int) )(let ((?x4366 ((_ Tn_05 0) n)))
(let ((?x3287 ((_ T2_01 0) n)))
(let (($x1107 (= ?x3287 ?x4366)))
(let (($x5310 (>= n 0)))
(=> $x5310 $x1107))))))
)
(check-sat)
