...
\note{All definitions are tested, though due to resource limitations, to different extents. \begin{itemize}
    \item In base 2, $T_{2,12}()$ is tested up to $2^{17} = 131,072$ entries
    \item In base 2, all other defs. up to $2^{27} = 134,217,728$ entries
    \item In bases $2 < x \le 8$, up to $2^{27}$ entries
    \item In bases $8 < x \le 16$, up to $2^{26} = 67,108,864$ entries
    \item In bases $16 < x \le 40$, up to $2^{25} = 33,554,432$ entries
    \item In bases $40 < x \le 56$, up to $2^{26}$ entries
    \item In bases $56 < x \le 96$, up to $2^{25}$ entries
\end{itemize}}
